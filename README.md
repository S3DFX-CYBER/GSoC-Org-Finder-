...
A high-performance, single-page application that enables GSoC 2026 applicants to analyze **184 selected organizations** and identify projects matching their technical expertise and domain interests.

Directly accessible via browser with no installation or build requirements.
...
<img width="8192" height="1328" alt="User Action Flow" src="https://github.com/user-attachments/assets/a56902d0-e172-42e9-b0d5-8a8ee2c7d156" />
...
|---------|---------|
| 🔍 Search | Full-text indexing across 184 organizations |
| 🏷️ Filters | Multi-criteria filtering by 15+ domains and 30+ languages |
| ⚖️ Compare | Side-by-side technical metric comparison (up to 3 orgs) |
| 🟢 Good Issues | Real-time aggregation of beginner-friendly issues |
| ⌨️ Keyboard Nav | Comprehensive ARIA-compliant keyboard support |
| 🌙 Dark Mode | Dynamic theme switching with persistence |
| 📱 Responsive | Adaptive layout for mobile, tablet, and desktop |

### 🔍 Discovery & Filtering
- 🔎 **Full-text search** — search by organization name, technology stack, or research topic
- 🏷️ **Domain filter** — Science, Web, Security, AI, OS, Media, Infrastructure, and more
- 💻 **Language filter** — Support for 30+ languages including Python, Rust, Go, and C++
- 🎯 **Multi-select language pills** — combine multiple language requirements for precise matching
- ⚡ **Status filters** — filter by GSoC veteran status, newcomer friendliness, competition metrics, and repository activity
- 📊 **Sort by** — Alphabetical, codebase complexity, competition level, and GitHub metrics

### 📊 Real-time GitHub Integration
- 🌟 **Repository Metrics** — Stars, Forks, Open Issues, and Last Commit timestamp fetched via serverless proxy
- 🟢 **Issue Tracking** — Dynamic count of Good First Issues per organization
- 🎖️ **Activity Indicators** — Automated activity classification based on recent commit frequency
- 🔗 **Smart Navigation** — Context-aware links to repositories or organization profiles

### 📋 Organization Analysis
- 📖 Detailed profiles with technology tags and contributor personas
- 📅 Historical GSoC participation timeline
- 📈 Quantitative metrics: years in program, competition index, and issue density
- 💡 **Project Ideas** — Validated links to organization-specific project proposals
- ➕ Integration with comparison engine

### ⚖️ Comparison Engine
- 🏆 Multi-org comparison (up to 3)
- 📊 Metrics: Category, program history, stars, forks, issues, and tech stack
- 🟢/🔴 Delta highlighting for comparative analysis

### 🟢 Issue Aggregator
- 📄 Centralized view of Good First Issues across all participating organizations
- ⚡ Live retrieval via GitHub API proxy with rate-limit management
- 🔎 Filtering by category, language, and keywords
- 🔗 Direct issue navigation sorted by recency

### ⏱ Program Timeline
- ⏰ Real-time countdown to application milestones
- 🔄 Dynamic state switching based on GSoC 2026 schedule

### 🔥 Personalization
- 📈 View history tracking for frequently accessed organizations
- 💾 Client-side persistence using `localStorage` (100% privacy-focused)
...
- Local session monitoring: searches, views, and filter usage
- Privacy-preserving data storage (zero external telemetry)

### 🌙 Adaptive UI
- High-contrast dark mode with persistence
- Mobile-optimized layouts and responsive components
...
No `node_modules`. No build step. No bundler. Deploy it directly.
...
- Check rate limits: `curl -H "Authorization: token <your-github-token>" https://api.github.com/rate_limit`
...
Found a missing org, wrong category, or incorrect tags? Pull requests are welcome.
...
- `hot` — high applicant volume, highly competitive (Django, LLVM, Git, KDE…)
