...
class TestCallLLM(unittest.TestCase):
    ...
    def test_retries_on_429(self, mock_sleep):
        ...
        error_429 = errors.APIError.__new__(errors.APIError)
        error_429.code = 429
        error_429.details = None
        ...
        result = call_llm(self.client, self.prompt, fail_closed=False)
    ...
    def test_fail_closed_on_429_exhausted(self):
        ...
        with patch('agent.tenet_agent.utils.time.sleep'):
            result = call_llm(self.client, self.prompt, fail_closed=True)
