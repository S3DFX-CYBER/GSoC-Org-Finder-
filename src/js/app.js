        ...
        <div class="org-logo-info">
          <div class="card-top-line">
            ...
            <div class="card-actions">
              ...
              <span class="cat-pill ${escapeHtml(catBdg(o.cat))}">${escapeHtml(catLabel(o.cat))}</span>
          ...
          ${repoHref?`<a class="card-repo-link" href="${escapeHtml(repoHref)}" target="_blank" rel="noopener noreferrer" onclick="event.stopPropagation()" title="${escapeHtml(repoHref)}">
            ...
            ${escapeHtml(repoLinkLabel(o))}
          </a>`:''}
        </div>
      </div>
      <div class="org-desc">${escapeHtml(o.desc || '')}</div>
      <div class="badges">
        <span class="b ${yBdg(o.years)}">${yLbl(o.years)} · ${escapeHtml(String(o.years))}y</span>
        <span class="b ${cBdg(o.competition)}">${cLbl(o.competition)}</span>
        <span class="b ${aBdg(act)}">${aLbl(act)}</span>
        ${o._gh?.gfi>0?`<span class="b bgfi">🟢 ${escapeHtml(String(o._gh.gfi))} GFI</span>`:''}
      </div>
